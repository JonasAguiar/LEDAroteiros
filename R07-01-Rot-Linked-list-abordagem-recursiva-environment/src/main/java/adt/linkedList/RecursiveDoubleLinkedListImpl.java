...
public class RecursiveDoubleLinkedListImpl<T> extends
	...
	public void insert(T element) {
		...
		if (super.size() == 0) {
			...
			this.setNext(new RecursiveDoubleLinkedListImpl<>(element,
					new RecursiveDoubleLinkedListImpl<>(), this));
		} else {
	...
	public void insertFirst(T element) {
		...
		RecursiveDoubleLinkedListImpl<T> aux = new RecursiveDoubleLinkedListImpl<>(super.getData(),
				super.getNext(), this);
		super.setData(element);
		super.setNext(aux);
	}
