...
public class HashtableOpenAddressLinearProbingImpl<T extends Storable> extends
	...
	public void insert(T element) {
		...
		if (element != null && this.search(element) == null) {
			...
			while (this.getElement(hashCode) != null && 
					!this.getElement(hashCode).equals(deletedElement) &&
	...
	public int indexOf(T element) {
		...
		if (element != null) {
			...
			if ((this.getElement(indice) == null) || (this.getElement(indice) != null 
					&& !this.getElement(indice).equals(element))) {
				indice = -1;
			}			
		} 
		return indice;
